...
public final class TextComponent extends es.angelillo15.mast.api.chat.api.chat.BaseComponent
{
     ...
     */
    public static es.angelillo15.mast.api.chat.api.chat.BaseComponent[] fromLegacyText(String message)
    {
     ...
     * @return the components needed to print the message to the client
     */
    public static es.angelillo15.mast.api.chat.api.chat.BaseComponent[] fromLegacyText(String message, ChatColor defaultColor)
    {
        ArrayList<es.angelillo15.mast.api.chat.api.chat.BaseComponent> components = new ArrayList<>();
        ...
        for ( int i = 0; i < message.length(); i++ )
        {
            ...
            { //Web link handling
                ...
                component.setClickEvent( new es.angelillo15.mast.api.chat.api.chat.ClickEvent( ClickEvent.Action.OPEN_URL,
