...
public class EntitySerializer implements JsonSerializer<es.angelillo15.mast.api.chat.api.chat.hover.content.Entity>, JsonDeserializer<es.angelillo15.mast.api.chat.api.chat.hover.content.Entity>
{

    @Override
    public es.angelillo15.mast.api.chat.api.chat.hover.content.Entity deserialize(JsonElement element, Type type, JsonDeserializationContext context) throws JsonParseException
    {
