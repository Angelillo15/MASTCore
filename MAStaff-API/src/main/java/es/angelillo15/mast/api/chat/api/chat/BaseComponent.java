...
public abstract class BaseComponent {
  ...
  public void copyFormatting(
      BaseComponent component, ComponentBuilder.FormatRetention retention, boolean replace) {
  ...
  public void retain(ComponentBuilder.FormatRetention retention) {
    if (retention == ComponentBuilder.FormatRetention.FORMATTING
        || retention == ComponentBuilder.FormatRetention.NONE) {
      setClickEvent(null);
      setHoverEvent(null);
    }
    if (retention == ComponentBuilder.FormatRetention.EVENTS
   ...
   * have one. {@link ChatColor#WHITE} is returned if no color is found.
   *
