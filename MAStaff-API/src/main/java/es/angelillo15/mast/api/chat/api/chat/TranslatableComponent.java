...
public final class TranslatableComponent extends es.angelillo15.mast.api.chat.api.chat.BaseComponent
{
    ...
    public TranslatableComponent(TranslatableComponent original)
    {
        ...
        {
            List<es.angelillo15.mast.api.chat.api.chat.BaseComponent> temp = new ArrayList<es.angelillo15.mast.api.chat.api.chat.BaseComponent>();
     ...
     * {@link es.angelillo15.mast.api.chat.api.chat.BaseComponent}s to use into the
     * translation
     * @see #translate
