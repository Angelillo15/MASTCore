...
public class TranslatableComponentSerializer extends BaseComponentSerializer
  ...
  @Override
  public TranslatableComponent deserialize(
    ...
    if (object.has("with")) {
      component.setWith(
          Arrays.asList(
              context.<BaseComponent[]>deserialize(object.get("with"), BaseComponent[].class)));
    }
    return component;
  }
  ...
  public JsonElement serialize(
      TranslatableComponent src, Type typeOfSrc, JsonSerializationContext context) {
