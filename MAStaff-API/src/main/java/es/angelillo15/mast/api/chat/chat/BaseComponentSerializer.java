...
public class BaseComponentSerializer
{
    ...
    protected void serialize(JsonObject object, BaseComponent component, JsonSerializationContext context)
    {
        ...
        {
            first = true;
            es.angelillo15.mast.api.chat.chat.ComponentSerializer.serializedComponents.set( Collections.newSetFromMap( new IdentityHashMap<BaseComponent, Boolean>() ) );
        }
        try
        {
            Preconditions.checkArgument( !es.angelillo15.mast.api.chat.chat.ComponentSerializer.serializedComponents.get().contains( component ), "Component loop" );
            es.angelillo15.mast.api.chat.chat.ComponentSerializer.serializedComponents.get().add( component );
        ...
        {
            es.angelillo15.mast.api.chat.chat.ComponentSerializer.serializedComponents.get().remove( component );
            if ( first )
            {
