...
public final class ComponentBuilder
{
    ...
    public ComponentBuilder(es.angelillo15.mast.api.chat.api.chat.BaseComponent component)
    {
        ...
        this( new es.angelillo15.mast.api.chat.api.chat.BaseComponent[]
        {
            component
        } );
    }
    ...
    private es.angelillo15.mast.api.chat.api.chat.BaseComponent getDummy()
    {
        if ( dummy == null )
        {
            dummy = new es.angelillo15.mast.api.chat.api.chat.BaseComponent()
            {
                @Override
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(es.angelillo15.mast.api.chat.api.chat.BaseComponent component, FormatRetention retention)
    {
        es.angelillo15.mast.api.chat.api.chat.BaseComponent previous = ( parts.isEmpty() ) ? null : parts.get( parts.size() - 1 );
        if ( previous == null )
        {
            previous = dummy;
            dummy = null;
     ...
     * @return this ComponentBuilder for chaining
     */
    public ComponentBuilder append(es.angelillo15.mast.api.chat.api.chat.BaseComponent[] components, FormatRetention retention)
    {
     ...
     * ({@code index < 0 || index >= size()})
     */
    public es.angelillo15.mast.api.chat.api.chat.BaseComponent getComponent(int pos) throws IndexOutOfBoundsException
    {
    ...
    {
        es.angelillo15.mast.api.chat.api.chat.BaseComponent[] cloned = new es.angelillo15.mast.api.chat.api.chat.BaseComponent[ parts.size() ];
        int i = 0;
