...
public class ConfigLoader {
    ...
    public void loadLanguages() {
        ...
        ConfigMerge.merge(new File(plugin.getDataFolder().toPath().toString() + File.separator + "lang/spanish.yml"),
                plugin.getResourceAsStream("BungeeCord/lang/spanish.yml")
        );

        ConfigMerge.merge(new File(plugin.getDataFolder().toPath().toString() + File.separator + "lang/english.yml"),
