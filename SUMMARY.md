...
* [🗝️ Permission Setup](introduction/permission-setup.md)

## Bukkit

* [🧭 Commands](bukkit/commands.md)
* [🖇️ Config](bukkit/config.md)
* [🔆 Glow](bukkit/glow.md)
* [🚘 Staff Vault](bukkit/staff-vault.md)
* [✈️ Placeholders](bukkit/placeholders.md)
* [🧻 Paper 1.17 Support](bukkit/paper-1.17-support.md)

## BungeeCord

* [🧭 Commands](bungeecord/commands.md)
* [🖇️ Config](bungeecord/config.md)
* [⚖️ Redis Sync](bungeecord/redis-sync.md)
